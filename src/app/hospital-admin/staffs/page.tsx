...
export default function ManageStaffs() {
  ...
  return (
    <div className="px-2 pt-5 pb-20 w-full overflow-y-auto overflow-x-hidden">
      <h1 className="text-xl md:text-2xl font-bold mb-6">Manage Department Staffs</h1>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Button 
            type="submit" 
            className="w-full md:col-span-2 py-2 h-auto" 
            disabled={loading}
          >
